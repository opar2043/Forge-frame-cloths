    ...
    new Set(
      (products || [])
        .map((p) => {
          ...
          if (category === "Trousers") category = "Trousers" ;
          return category;
        })
        .filter(
          (c) =>
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <div className="flex items-center gap-3">
              ...
              {user ? (
                <button
                  onClick={logOut}
                  className="px-4 py-2 rounded-lg bg-[#1E1E1E] text-white font-semibold text-xs hover:bg-[#333] shadow-md hover:shadow-lg transition-all duration-300"
                  aria-label="Logout"
                >
                  Log Out
                </button>
                ...
                <Link to="/login" aria-label="Account">
                  <button
                    type="submit"
                    className="px-4 py-2 rounded-lg bg-[#F6E0D9] text-slate-900 font-semibold text-xs hover:bg-[#e7c9c0] shadow hover:shadow-md transition-all duration-300"
                  >
                    Sign In
                  </button>
                </Link>
